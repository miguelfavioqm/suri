  ...
  return (
    <section>
      ...
      <ul className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-10">
        ...
        <a className="flex items-center justify-center gap-1 hover:text-green-500 cursor-pointer hover:border-x-8 border-green-500 w-full md:w-auto md:hover:border-x-0 md:hover:animate-bounce">
          <BiLogoWhatsapp />
          <p>WHATSAPP</p>
        </a>
        <a
